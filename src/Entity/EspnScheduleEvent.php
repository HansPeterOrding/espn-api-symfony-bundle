...
#[ORM\Table(name: 'easb_espn_schedule_event')]
#[ORM\Index(name: 'idx_easb_espn_schedule_event_season_id_season_type_week_number', columns: ['season_id', 'season_type', 'week_number'])]
